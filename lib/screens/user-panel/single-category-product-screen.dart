...
class AllSingleCategoryProduct extends StatefulWidget {
   String categoryId;
   AllSingleCategoryProduct({super.key, required  this.categoryId});

  @override
  State<AllSingleCategoryProduct> createState() => _AllSingleCategoryProductState();
}

class _AllSingleCategoryProductState extends State<AllSingleCategoryProduct> {
  @override
